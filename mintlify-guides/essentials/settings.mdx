...
Organize your pages into tabs and groups. See the [Navigation](/mintlify-guides/essentials/navigation) guide for full details.
...
The contextual toolbar floats on every page and gives readers one-click access to AI tools and integrations. See [Contextual toolbar](/mintlify-guides/agent-ready/contextual) for the full list of options.
