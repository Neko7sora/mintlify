...
<Columns cols={2}>
  <Card title="API Reference" icon="terminal" href="/mintlify-guides/api-reference/introduction">
    Auto-generated docs from your OpenAPI spec.
  </Card>
  <Card title="Quickstart" icon="rocket" href="/mintlify-guides/quickstart">
