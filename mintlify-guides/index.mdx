...
<Card
  title="Start here"
  icon="rocket"
  href="/mintlify-guides/quickstart"
  horizontal
>
...
<Columns cols={2}>
  <Card
    title="Edit locally"
    icon="pen-to-square"
    href="/mintlify-guides/development"
  >
  ...
  <Card
    ...
    icon="palette"
    href="/mintlify-guides/essentials/settings"
  >
    ...
    icon="map"
    href="/mintlify-guides/essentials/navigation"
  >
  ...
  <Card
    ...
    icon="terminal"
    href="/mintlify-guides/api-reference/introduction"
  >
...
<Columns cols={2}>
  <Card
    ...
    icon="pen-fancy"
    href="/mintlify-guides/essentials/markdown"
  >
  ...
  <Card
    title="Code samples"
    icon="code"
    href="/mintlify-guides/essentials/code"
  >
  ...
  <Card
    title="Images"
    icon="image"
    href="/mintlify-guides/essentials/images"
  >
  ...
  <Card
    ...
    icon="recycle"
    href="/mintlify-guides/essentials/reusable-snippets"
  >
...
<Columns cols={2}>
  <Card
    ...
    icon="robot"
    href="/mintlify-guides/agent-ready/prompt"
  >
  ...
  <Card
    title="Visibility"
    icon="eye"
    href="/mintlify-guides/agent-ready/visibility"
  >
  ...
  <Card
    ...
    icon="bolt"
    href="/mintlify-guides/agent-ready/contextual"
  >
  ...
  <Card
    ...
    href="/mintlify-guides/ai-tools/claude-code"
  >
